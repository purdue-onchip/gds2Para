        ...
        if (ind == SG){
            ...
            while (index < sys->leng_S){
                ...
                if (sys->markEdge[start + sys->N_edge_s] != 0) {
                    ...
                    temp2[0][start] = sqrt(sys->stackEpsn[(start + sys->N_edge_s + sys->N_edge_v) / (sys->N_edge_s + sys->N_edge_v)] * EPSILON0) * U0[U0_i - 1][start];
                }
                else {
                    temp1[0][start] = 0;
                    temp2[0][start] = sqrt(sys->stackEpsn[(start + sys->N_edge_s + sys->N_edge_v) / (sys->N_edge_s + sys->N_edge_v)] * EPSILON0) * U0[U0_i - 1][start];
            ...
            while (index < sys->leng_S){
                ...
                if (sys->markEdge[start + sys->N_edge_s] != 0){
                    ...
                    temp2[(U0_i - 1)][start] = sqrt(sys->stackEpsn[(start + sys->N_edge_s + sys->N_edge_v) / (sys->N_edge_s + sys->N_edge_v)] * EPSILON0) * U0[(U0_i - 1)][start];
                }
                else {
